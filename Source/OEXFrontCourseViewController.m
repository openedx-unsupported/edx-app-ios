...
- (void)awakeFromNib {
    ...
    __weak OEXFrontCourseViewController *weakSelf = self;
    [self.progressController.downloadButton oex_addAction:^(id __nonnull control) {
        [[OEXRouter sharedRouter] showDownloadsFromViewController:weakSelf];
