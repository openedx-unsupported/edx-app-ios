...
- (id)initWithCoder:(NSCoder*)aDecoder {
    ...
    if(self) {
        ...
        [self.btn_Cancel setTitle:OEXLocalizedString(@"CANCEL", nil) forState:UIControlStateNormal];
        ...
        [self.btn_Edit setTitle:OEXLocalizedString(@"EDIT", nil) forState:UIControlStateNormal];
        ...
        [self.btn_Delete setTitle:OEXLocalizedString(@"DELETE", nil) forState:UIControlStateNormal];
