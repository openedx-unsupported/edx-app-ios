...
NSString* const OEXAnalyticsScreenViewTopics = @"View Topics";
NSString* const OEXAnalyticsScreenViewTopicThreads = @"View Topic Threads";
NSString* const OEXAnalyticsScreenSearchThreads = @"Search Threads";
NSString* const OEXAnalyticsScreenCreateTopicThread = @"Create Topic Thread";
NSString* const OEXAnalyticsScreenViewThread = @"View Thread";
NSString* const OEXAnalyticsScreenAddThreadResponse = @"Add Thread Response";
NSString* const OEXAnalyticsScreenAddResponseComment = @"Add Response Comment";
NSString* const OEXAnalyticsScreenViewResponseComments = @"View Response Comments";
