...
extension String {
    ...
    // We use this string decoding method from the source https://gist.github.com/akerenyi/659097f78c56cb82ad16af73e2c23773
    ...
    var decodingHTMLEntities: String {
        ...
        func decoding(htmlEntities encodedString: String) -> String {
            ...
            guard let ampRange = encodedString.range(of: "&", range: index ..< encodedString.endIndex) else {
                return encodedString
            }
        
            result.append(encodedString[position ..< ampRange.lowerBound])
