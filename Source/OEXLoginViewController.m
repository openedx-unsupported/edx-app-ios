...
- (void)viewDidLoad {
    ...
    ExternalAuthOptionsView* externalAuthOptions = [[ExternalAuthOptionsView alloc] initWithFrame:self.externalAuthContainer.bounds providers:providers state:ExternalAuthOptionsViewStateLogin accessibilityLabel:[Strings signInPrompt] tapAction:^(id<OEXExternalAuthProvider> provider) {
