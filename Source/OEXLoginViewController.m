...
- (void)viewDidLoad {
    ...
    ExternalAuthOptionsView* externalAuthOptions = [[ExternalAuthOptionsView alloc] initWithFrame:self.externalAuthContainer.bounds providers:providers type:ExternalAuthOptionsTypeLogin tapAction:^(id<OEXExternalAuthProvider> provider) {
