...
- (void)viewDidLoad {
    ...
    ExternalAuthOptionsView* externalAuthOptions = [[ExternalAuthOptionsView alloc] initWithFrame:self.externalAuthContainer.bounds providers:providers type:ExternalAuthOptionsTypeLogin accessibilityLabel:@"" tapAction:^(id<OEXExternalAuthProvider> provider) {
