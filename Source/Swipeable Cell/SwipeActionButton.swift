...
class SwipeActionButton: UIButton {
    ...
    func titleBoundingRect(with size: CGSize) -> CGRect {
        ...
        return title.boundingRect(with: size, options: [.usesLineFragmentOrigin], attributes: [NSAttributedStringKey.font: OEXStyles.shared().semiBoldSansSerif(ofSize: 15)], context: nil)
    }
