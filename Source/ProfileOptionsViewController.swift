...
extension ProfileOptionsViewController: RestorePurchasesCellDelegate {
    ...
    private func resolveUnfinishedPayment(for sku: String, indicator: UIAlertController?) {
        ...
        environment.analytics.trackCourseUnfulfilledPurchaseInitiated(courseID: course.course_id ?? "", pacing: pacing, screen: .myCourses, flowType: CourseUpgradeHandler.CourseUpgradeMode.restore.analyticsText)
