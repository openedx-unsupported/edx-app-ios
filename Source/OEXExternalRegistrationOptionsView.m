...
- (id)initWithFrame:(CGRect)frame providers:(NSArray *)providers {
    ...
    if(self != nil) {
        ...
        self.authOptionsView = [[ExternalAuthOptionsView alloc] initWithFrame:self.bounds providers:providers state:ExternalAuthOptionsViewStateRegister accessibilityLabel:[Strings registrationRegisterPrompt] tapAction:^(id<OEXExternalAuthProvider> provider) {
