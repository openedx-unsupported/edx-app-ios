...
class AnswerAnalyticsTracker: NSObject, OEXAnalyticsTracker {
    ...
    let trackEventsAllowed = [AnalyticsDisplayName.EnrolledCourses.rawValue, AnalyticsDisplayName.CreateAccount.rawValue, AnalyticsDisplayName.RegistrationSuccess.rawValue]
