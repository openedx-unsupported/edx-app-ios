...
class AccountViewCell: UITableViewCell {
    ...
    private let fontSyle = OEXTextStyle(weight: .normal, size: .large, color : OEXStyles.shared().neutralBlack())
    public var title : String? {
        didSet {
            titleLabel.attributedText = fontSyle.attributedString(withText: title)
        }
    }
