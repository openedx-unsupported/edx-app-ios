...
- (void)viewDidLoad {
    ...
    [self.signInButton.titleLabel setFont:[[OEXStyles sharedStyles] boldSansSerifOfSize:14.0f]];
    [self.signUpButton.titleLabel setFont:[[OEXStyles sharedStyles] sansSerifOfSize:18.0f]];
}
