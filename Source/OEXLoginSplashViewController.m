...
- (void)viewDidLoad {
    ...
    [self.signUpButton applyButtonStyleWithStyle:[self.environment.styles filledButtonStyleWithColor:self.environment.styles.signUpButtonColor] withTitle:[Strings loginSplashSignUp]];
}
