...
install_xcframework "${PODS_ROOT}/GoogleAnalytics/Frameworks/GoogleAnalytics.xcframework" "GoogleAnalytics" "framework" "ios-arm64_armv7" "ios-arm64_x86_64-maccatalyst" "ios-arm64_i386_x86_64-simulator"
