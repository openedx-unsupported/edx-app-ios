...
install_xcframework "${PODS_ROOT}/NewRelicAgent/NewRelic.xcframework" "NewRelic" "framework" "ios-i386_x86_64-simulator" "ios-arm64_arm64e_armv7" "ios-x86_64-maccatalyst"
