...
@interface FlowErrorViewController ()
...
static FlowErrorViewController * _sharedInterface = nil;

@implementation FlowErrorViewController

+ (id)sharedInstance
{
    if (!_sharedInterface) {
        _sharedInterface = [[FlowErrorViewController alloc] init];
    }
