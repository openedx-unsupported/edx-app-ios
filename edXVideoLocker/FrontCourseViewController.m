...
#import "FrontCourseViewController.h"
...
@interface FrontCourseViewController ()
...
@property(nonatomic,strong) CustomTabBarViewViewController *obj_customtab;
...
@implementation FrontCourseViewController
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
     if([[segue  identifier] isEqualToString:@"LaunchCourseDetailTab"]){
        ...
        CustomTabBarViewViewController *obj_customtab_temp = (CustomTabBarViewViewController *)[segue destinationViewController];
...
-(void)findCourses:(id)sender
{
    ...
    [Analytics trackUserFindsCourses];
}
...
//    ELog(@"%d",indexPath.section);
    if (indexPath.section<[self.arr_CourseData count])
    {
        ...
        Course *obj_course = [self.arr_CourseData objectAtIndex:indexPath.section];
    ...
    else
    {
        ...
        FindCourseTableViewCell *cellFind = [tableView dequeueReusableCellWithIdentifier:cellIndentifier];
