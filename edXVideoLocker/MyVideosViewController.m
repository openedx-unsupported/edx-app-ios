...
- (void)viewDidLoad
{
    ...
    [Analytics screenViewsTracking: @"My Videos - All Videos"];
...
- (NSString *)calculateVideosSizeInCourse:(NSArray *)arrvideo
{
    ...
    for (HelperVideoDownload *videos in arrvideo)
    {
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    else
    {
        ...
        Course *obj_course = [dictVideo objectForKey:CAV_KEY_COURSE];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView == self.table_MyVideos)
    {
        ...
        FrontTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellIndentifier];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView == self.table_MyVideos)
    {
        ...
        MyVideosSubSectionViewController *objSub = [storyboard instantiateViewControllerWithIdentifier:@"MyVideosSubsection"];
...
- (void)cancelTableClicked:(id)sender
{
    ...
    {
        for (HelperVideoDownload *obj_video in [dict objectForKey:CAV_KEY_RECENT_VIDEOS])
        {
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row)
    {
        ...
        case 1: //Recent Videos
            ...
            //Analytics Screen record
            [Analytics screenViewsTracking: @"My Videos - Recent Videos"];
        ...
        if (buttonIndex == 1)
        {
            ...
            for (HelperVideoDownload *selectedVideo in self.arr_SelectedObjects)
            {
                ...
                for (NSDictionary *dict in arrCopySubsection)
                {
                    ...
                    for (HelperVideoDownload *videos in arrvideos)
                    {
