    ...
    open static func freshCourseOutline(_ courseID : String) -> CourseOutline {
        return CourseOutline(
            ...
            blocks : [
                ...
                "chapter4": CourseBlock(type: CourseBlockType.Chapter, children : ["section4.1"], blockID : "chapter4", minifiedBlockID: "123456", name : "Chapter 4", blockCounts : ["video" : 1], multiDevice : true),
                ...
                "section1.2": CourseBlock(type: CourseBlockType.Section, children : ["unit1", "unit2"], blockID : "section1.2", minifiedBlockID: "123456", name : "Section 2", blockCounts : ["video" : 1], multiDevice : true),
                "section1.3": CourseBlock(type: CourseBlockType.Section, children : ["unit1", "unit2"], blockID : "section1.3", minifiedBlockID: "123456", name : "Section 3", blockCounts : ["video" : 1], multiDevice : true),
                "section1.4": CourseBlock(type: CourseBlockType.Section, children : ["unit1", "unit2"], blockID : "section1.4", minifiedBlockID: "123456", name : "Section 4", blockCounts : ["video" : 1], multiDevice : true),
                ...
                "section4.1": CourseBlock(type: CourseBlockType.Section, children : ["unit1", "unit2"], blockID : "section4.1", minifiedBlockID: "123456", name : "Section 1", blockCounts : ["video" : 1], multiDevice : true),
