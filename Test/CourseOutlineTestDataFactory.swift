...
open class CourseOutlineTestDataFactory {
    ...
    static let resumeCourseItem = ResumeCourseItem(lastVisitedBlockID: "block2", lastVisitedBlockName: "Block 2")
