    ...
    open static func freshCourseOutline(_ courseID : String) -> CourseOutline {
        return CourseOutline(
            ...
            blocks : [
                ...
                "section3.1": CourseBlock(type: CourseBlockType.Section, children : [], blockID : "section3.1", minifiedBlockID: "123456", name : "Section 1", dueDate:"2017-08-04T00:00:00Z", format:"Homework", multiDevice : true),
