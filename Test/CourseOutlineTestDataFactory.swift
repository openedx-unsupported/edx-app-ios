    ...
    public static func freshCourseOutline(courseID : String) -> CourseOutline {
        return CourseOutline(
            ...
            blocks : [
                ...
                "chapter4": CourseBlock(type: CourseBlockType.Chapter, children : ["section4.1"], blockID : "chapter4", name : "Chapter 4"),
                ...
                "section3.1": CourseBlock(type: CourseBlockType.Section, children : [], blockID : "section3.1", name : "Section 1"),
                "section4.1": CourseBlock(type: CourseBlockType.Section, children : [], blockID : "section4.1", name : "Section 1"),
