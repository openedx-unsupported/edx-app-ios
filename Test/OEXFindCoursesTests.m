...
-(void)testFindCoursesURLRecognition{
    FindCoursesWebViewHelper* helper = [[FindCoursesWebViewHelper alloc] initWithConfig:nil delegate:nil bottomBar:nil showSearch:YES searchQuery:nil showSubjects:YES];
