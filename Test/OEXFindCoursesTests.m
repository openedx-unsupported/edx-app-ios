...
@interface OEXFindCoursesViewController (TestCategory) <WebViewNavigationControllerDelegate>
-(NSString *)getCoursePathIDFromURL:(NSURL *)url;
@end

@interface OEXCourseInfoViewController (TestCategory) <WebViewNavigationControllerDelegate>
