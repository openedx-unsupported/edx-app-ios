...
class CourseOutlineHeaderViewTests : SnapshotTestCase {
    ...
    func testHeaderInfoView() {
        let headerInfoView = CourseOutlineHeaderView(frame: CGRect.zero, styles: OEXStyles(), titleText: Strings.resume, subtitleText : "This is a very long subtitle which should not overlap the button")
