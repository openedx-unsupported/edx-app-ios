...
class VideoBlockViewControllerTests : SnapshotTestCase {
    ...
    func testSnapshotYoutubeOnly() {
        ...
        let outline = CourseOutline(root: "root", blocks: [
            ...
            "video" : CourseBlock(type: CourseBlockType.Video(summary), children: [], blockID: "video", minifiedBlockID: "123456", name: "Youtube Video", blockURL: URL(string: "www.example.com"), multiDevice: true, graded: false)
            ])
