...
- (void)testShowSplashWhenLoggedOut {
    OEXRouterEnvironment* environment = [[OEXRouterEnvironment alloc] initWithAnalytics:nil config:nil interface:nil pushSettingsManager:nil session:nil styles:nil];
...
- (void)testShowContentWhenLoggedIn {
    OEXRouterEnvironment* environment = [[OEXRouterEnvironment alloc] initWithAnalytics:nil config:nil interface:nil pushSettingsManager:nil session:self.loggedInSession styles:nil];
    OEXRouter* router = [[OEXRouter alloc] initWithEnvironment:environment];
    [router openInWindow:nil];
...
- (void)testShowNewAnnouncement {
    ...
    OEXRouterEnvironment* environment = [[OEXRouterEnvironment alloc] initWithAnalytics:nil config:nil interface:interface pushSettingsManager:nil session:self.loggedInSession styles:nil];
    OEXRouter* router = [[OEXRouter alloc] initWithEnvironment:environment];
    [router openInWindow:nil];
